...
Following the Next.js App Router Course. Learning Next.JS for use in future projects!

Things learned so far: 
- partial rendering using layouts in Next.JS
- using the <Link> component to create client sided navigation leading to faster page switches <br> by prefetching the code for linked routes in the background
...
Vist the site at: https://nextjs-dashboard-omega-taupe-14.vercel.app/
